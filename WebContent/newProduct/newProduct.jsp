...
<header>
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-content">
        <a href="newProduct.jsp?co=p_record desc">신상품</a>
        <a href="newProduct.jsp?co=p_recommend desc">추천순</a>
        <a href="newProduct.jsp?co=p_price desc">높은 가격</a>
        <a href="newProduct.jsp?co=p_price">낮은 가격</a>
      </div>
    </div>
    <br>
</header>
...
<table class="paging" align="center">
	<tr>
		...
		<%
		if(userGroup!=0){
			%><a href="newProduct.jsp?cp=<%=(userGroup-1)*pageSize+pageSize %>">&nvlArr;</a><%
		}
		%>
		<%
			for(int i=userGroup*pageSize+1;i<=userGroup*pageSize+pageSize;i++){
				%>&nbsp;&nbsp;<a href="newProduct.jsp?cp=<%=i%>"><%=i %></a>&nbsp;&nbsp;<%
				if(i==totalPage){
					break;
				}
			}
		...
		if(userGroup!=(totalPage/pageSize-(totalPage%pageSize==0?1:0))){
			%><a href="newProduct.jsp?cp=<%=(userGroup+1)*pageSize+1%>">&nvrArr;</a><%
		}
		%>
		</td>
	</tr>
